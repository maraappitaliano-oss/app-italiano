    ...
    <div className="flex min-h-screen items-start justify-center" style={{ background: "var(--color-ice-white)" }}>
      <main className="flex w-full max-w-4xl flex-col items-start gap-6 py-16 px-6">
        <div className="flex items-center gap-2">
          <FileAudio size={22} color={"var(--color-navy-italy)"} />
          <h1 className="text-2xl font-semibold" style={{ color: "var(--color-navy-italy)", fontFamily: "var(--font-title)" }}>Simulação de Entrevista</h1>
        </div>
        <p className="text-sm" style={{ color: "#333" }}>Placeholder: visual formal, pergunta com áudio+texto, resposta por falar/digitar/selecionar e pontuação final.</p>
      </main>
    </div>
  );
}